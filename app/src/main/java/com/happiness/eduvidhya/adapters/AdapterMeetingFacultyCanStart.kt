...
class AdapterMeetingFacultyCanStart(
    val context: Context,
    show_batches: ArrayList<ModelMeetings>?,
    strFacultyEmail: String, strClassNameComeFromClasses: String
) : RecyclerView.Adapter<AdapterMeetingFacultyCanStart.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.custom_row_all_meetings_start_by_faculty_or_user, parent, false)
