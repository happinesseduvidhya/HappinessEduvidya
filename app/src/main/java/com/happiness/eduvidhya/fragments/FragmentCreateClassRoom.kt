    ...
    override fun onCreateView(
        ...
        create_classroom_btn.setOnClickListener {
            if (enter_classroom_name.text.toString().isEmpty()) {
                ...
                val classroom_detail =
                    ClassroomDetailsModel(classroom_name, subject_name, topic_name,"")
                ...
                create_classroom = teacher_collection.document(email!!).collection("classrooms")
                    .document(enter_classroom_name.text.toString())
                create_classroom!!.set(classroom_detail).addOnSuccessListener {
                    Toast.makeText(
                        context, "Successfully created class",
                        Toast.LENGTH_SHORT
                    ).show()
        ...
        add_batch.setOnClickListener {
            mRecyclerAdapter = BatchListRecyclerAdapter(
                requireActivity(),
                myList,
                this,enter_classroom_name.text.toString(),
                subject_name_edit.text.toString(),
                topic_name_edit.text.toString()
            )
