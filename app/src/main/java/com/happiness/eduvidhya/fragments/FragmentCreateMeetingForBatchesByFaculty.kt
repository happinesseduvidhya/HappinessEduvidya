...
class FragmentCreateMeetingForBatchesByFaculty : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        spinnerBatches = v.findViewById(R.id.spinnerBatches)
...
//            ).show()
        ...
        val strEmail = mySharedPreferences.getString("user_email", "")
        ...
        spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            ...
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                mBatchesAll(strEmail.toString(),strClass.toString())
            }
                ...
                call.enqueue(object : Callback<response> {
                    ...
                    override fun onResponse(
                        ...
                        if (dataValue == null) {
                            ...
                            classes.document(email.toString()).collection("classrooms").document(strClass.toString()).collection("Batches").
                            document(strBatchID).collection("Meetings").
                            document(display_code_value.text.toString()).set(meetingsModel).addOnSuccessListener {
                                updatedProgressDilaog.dialog.dismiss()
        ...
        if (Constant.hasNetworkAvailable(requireContext())) {
            ...
            classes.document(email).collection("classrooms").document(strClass).collection("Batches").addSnapshotListener(object :
                ...
                override fun onEvent(value: QuerySnapshot?, error: FirebaseFirestoreException?) {
                    ...
                    val adapter = ArrayAdapter(requireContext(), R.layout.custom_spinner,
                        list_of_batches!!
                    )
